...
```sh
curl https://github.com/jmcantrell/bootstrap-arch/blob/main/scripts/inject?raw=true | bash -s
```
...
```
script=https://github.com/jmcantrell/bootstrap-arch/blob/main/scripts/inject?raw=true
```
