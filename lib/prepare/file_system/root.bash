...
if [[ ! -v BOOTSTRAP_FS_ROOT_OPTIONS ]]; then
    options_file="$BOOTSTRAP_CONFIG_DIR"/file_system/$BOOTSTRAP_FS_ROOT_KIND/options
...
package_file=$BOOTSTRAP_CONFIG_DIR/packages/file_system/$BOOTSTRAP_FS_ROOT_KIND
